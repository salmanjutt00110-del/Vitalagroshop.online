      ...
      <section className="bg-gradient-to-b from-[#020703] via-[#051107] to-neutral-950 py-20 relative overflow-hidden border-b border-emerald-900/5">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <span className="text-sm font-bold tracking-widest uppercase text-[#18C964] block mt-2">About Us</span>
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-neutral-200 mt-2 mb-4">Our Story</h2>
      ...
      <section className="py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-[#0E7A43]/10 flex items-center justify-center mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className="w-16 h-16 rounded-2xl bg-[#0E7A43]/10 flex items-center justify-center mx-auto mb-6">
