      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl rounded-[32px] overflow-hidden border border-white/12 shadow-[0_30px_70px_rgba(0,0,0,0.8),0_0_50px_rgba(16,185,129,0.1)] aspect-video select-none transform-gpu flex flex-col justify-center items-center bg-white/[0.05]"
          ...
          >
            ...
            <div className="relative w-full h-full flex items-center justify-center overflow-hidden rounded-[32px] border border-white/5">
              
              {/* Skeleton Loader overlay */}
              {isLoading && (
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-neutral-950/90 gap-4">
                  ...
                  <div className="w-48 h-3 bg-white/5 rounded-full overflow-hidden relative">
            ...
            <button
              ...
              className="absolute top-4 right-4 z-30 w-10 h-10 rounded-full flex items-center justify-center
                bg-black/40 backdrop-blur-md border border-white/15 text-white/70 
                hover:text-white hover:bg-black/70 hover:border-emerald-500/40 hover:rotate-90 hover:scale-115
